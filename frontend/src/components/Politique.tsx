      ...
      <main className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-lg p-8 md:p-12 mb-8 border border-[#C5A065]/10">
          <p className="text-lg text-[#2D2A26] mb-8 leading-relaxed">
            ...
            acheté ne répond pas à vos attentes, nous vous invitons à lire notre
            politique de retour pour savoir comment procéder.
          </p>
          ...
          <section className="mb-12">
            ...
            <p className="text-[#2D2A26] mb-4">
              En raison de la nature périssable de nos produits, les articles
              suivants ne peuvent pas être retournés ni échangés :
            </p>
          ...
          <section className="mb-12">
            <div className="flex items-start gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-[#2D2A26]">
                Retours en cas de problème de qualité
              </h2>
            </div>
            <p className="text-[#2D2A26] mb-4">
              Si un produit acheté ne répond pas aux normes de qualité (produit
              avarié, mauvaise conservation, erreur de préparation), vous pouvez
              faire une réclamation dans un délai de 48 heures suivant l'achat.
            </p>

            <div className="bg-amber-50 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
              <p className="text-amber-800 text-sm italic">
                &quot;Nos produits peuvent contenir des traces de noix, de
                fruits à coque, et d'autres allergènes. Bien que nous ne
                travaillions pas avec des arachides dans notre atelier, nous ne
                pouvons garantir l'absence de contamination croisée. Veuillez
                nous signaler toute allergie alimentaire avant de faire votre
                achat.&quot;
              </p>
            </div>

            <div className="bg-blue-50 rounded-xl p-6">
              <h3 className="font-bold text-[#2D2A26] mb-3">
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  <span>
                    Un justificatif d'achat vous sera demandé (ticket de caisse,
                    facture ou commande en ligne)
                  </span>
                </li>
              </ul>
            </div>
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gray-50 rounded-xl p-6">
                <h3 className="font-bold text-[#2D2A26] mb-4 text-lg">
                  Étapes à suivre :
                </h3>
          ...
          {[
            {
              ...
              content:
                "En cas de produit défectueux ou de problème de qualité, nous nous engageons à vous proposer un échange ou un remboursement intégral. Si vous préférez un échange, nous ferons de notre mieux pour vous offrir un produit similaire selon la disponibilité.",
            },
            {
              number: 5,
              title: "Produits sur commande",
              content:
                "Les produits personnalisés, tels que les gâteaux de fête ou les commandes spéciales, ne sont pas remboursables ni échangeables, sauf en cas de défaut ou d'erreur de préparation de notre part.",
            },
            {
              number: 6,
              title: "Modifications de la politique",
              content:
                "Cette politique de retour peut être modifiée à tout moment. Nous vous conseillons de consulter régulièrement cette page pour vous assurer que vous êtes informé des éventuels changements.",
            },
          ].map((section, index) => (
          ...
          <div className="mt-12 pt-8 border-t border-[#C5A065]/20 text-center">
            ...
            <p className="text-[#2D2A26]/70">
              N'hésitez pas à nous contacter pour toute question ou pour toute
